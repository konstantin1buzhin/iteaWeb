		...
		<div class="top-header">
			<div class="wrap">
				...
				<div class="header-right">
					<ul>
						<li><i class="user"></i> <a href="/eStoreSpring/login" id="userName">${sessionScope.currentUserName}</a></li>
									...
									<div class="h_nav">
										...
										<ul>
											...
											<li><a href="/eStoreSpring/registration">create an
													account</a></li>
											<li><a href="/eStoreSpring/login">my shopping
													bag</a></li>
										</ul>
									</div>
								</div>
							...
							<div class="product">
								...
								<a href="/eStoreSpring/products?id=${product.key.id}"><div
										...
										<img height="${imgHeight}"
											src="<c:url value='/resources/images/${product.key.id}.jpg' />" alt="" />
									</div></a>
								...
								<input type='button' value='Details' style="color: blue;"
									onclick="javascript:location.href='/eStoreSpring/products?id=${product.key.id}'" /> <br> <img
